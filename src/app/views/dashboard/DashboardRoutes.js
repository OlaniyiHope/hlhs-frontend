...
const dashboardRoutes = [
  ...
  { path: "/dashboard/ss1-subject", element: <Sub4 />, auth: authRoles.admin },
  { path: "/dashboard/ss2-subject", element: <Sub5 />, auth: authRoles.admin },
  { path: "/dashboard/ss3-subject", element: <Sub6 />, auth: authRoles.admin },
